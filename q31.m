...
hold on
plot(Tpf,Rcpf,'g','LineWidth',2)
plot(Tpf2,Rdpf,'b','LineWidth',2)
TE=sprintf('R=%0.3fT+%0.3f',m,b);
text(9,10,TE,'BackgroundColor','w','EdgeColor','g','Color','g','FontSize',10)
TE2=sprintf('R=%0.3fT+%0.3f',m2,b2);
text(9.3,10.4,TE,'BackgroundColor','w','EdgeColor','b','Color','b','FontSize',10)